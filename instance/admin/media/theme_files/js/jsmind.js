    ...
    jm.prototype = {
        ...
        click_handle: function (e) {
            ...
            if(element.innerHTML=="+"){
            	$("#created_at").val(this.view.get_binded_nodeid(element));
            	$("#created_at_under").val(this.view.selected_node.parent.id);
            	$('#new_node').modal('show'); 
            	console.log(this.view.selected_node.parent.id);
            	console.log(this.view.get_binded_nodeid(element));
                //openAddOptionPopop(this.view.get_binded_nodeid(element));
                
            }else if(element.innerHTML=="Add New Trigger"){
                openTriggerPopup();
            }
            if (isexpander) {
                var nodeid = this.view.get_binded_nodeid(element);
